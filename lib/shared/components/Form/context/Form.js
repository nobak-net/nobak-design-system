...
export var FormProvider = function FormProvider(_ref) {
  ...
  var getFormData = function getFormData() {
    return ['input', 'textarea'].map(function (tagName) {
      ...
      var htmlCollection = formRef === null || formRef === void 0 || (_formRef$current = formRef.current) === null || _formRef$current === void 0 ? void 0 : _formRef$current.getElementsByTagName(tagName);
      if (htmlCollection === undefined) return;
      var formFields = Array.from(htmlCollection || []);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 13:
            data = _context.sent;
            console.log(data);
            if (Boolean(afterSubmit) && data) {
              afterSubmit(data);
            }
            _context.next = 19;
            break;
          case 18:
            console.log('DEBUG FORM ON 🐛:', formState);
          case 19:
            _context.next = 24;
            break;
          case 21:
  ...
  }, children), debug && formState && /*#__PURE__*/React.createElement(Debug, null, formState.map(function (_ref4) {
    var id = _ref4.id,
      value = _ref4.value;
    return /*#__PURE__*/React.createElement("div", null, id, ": ", value);
  })));
};
