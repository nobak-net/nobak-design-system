...
export var TextInput = function TextInput(_ref) {
  ...
  var iconStyle = clsx('absolute inset-y-0 right-0 pr-3 flex items-center text-neutral-400', status === 'VALID' && 'text-green-400', status === 'ERROR' && 'text-red-400');
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-neutral-800"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: icon
