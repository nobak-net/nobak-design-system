...
export var NumberInput = function NumberInput(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            setValue(newValue);
            _context.next = 5;
            return validation === null || validation === void 0 ? void 0 : validation.fn(newValue);
          case 5:
            e = _context.sent;
            updateForm();
            if (e.valid === true) {
  ...
  var inputStyle = clsx("shadow-sm focus:ring-primary-1000 focus:border-primary-1000 block w-full sm:text-sm border border-neutral-400 rounded-md text-neutral-1600 bg-neutral-200", status === 'VALID' && 'border-green-400 focus:ring-green-500 focus:border-green-500', status === 'ERROR' && 'border-red-400 focus:ring-red-500 focus:border-red-500', !!icon && 'pl-10');
  var iconStyle = clsx('absolute inset-y-0 right-0 pr-3 flex items-center text-neutral-800', status === 'VALID' && 'text-green-400', status === 'ERROR' && 'text-red-400');
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    htmlFor: id,
    className: !hidden ? "block text-sm font-medium text-neutral-1600" : 'hidden'
    ...
    className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-neutral-1600"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: icon
