...
export var DefaultInput = function DefaultInput(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    className: "shadow-sm focus:ring-primary-1000 focus:border-primary-1000 block w-full sm:text-sm border-neutral-400 rounded-md text-neutral-1600 bg-neutral-200 ".concat(disabled && 'text-neutral-1200 cursor-not-allowed'),
